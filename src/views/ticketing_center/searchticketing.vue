    ...
    <div class="ticket">
        <el-collapse accordion>
            <!-- <el-collapse-item title="高频彩">
                <div class="eleven">
                    <h3>11选5</h3>
                    <el-radio v-model="type" label= "50" border style="margin:5px;" size="mini">山东11选5</el-radio>
        ...
        <div class="search">
            <div class="search-top">
                提供商:<el-radio v-model="provider" label="-1" border style="margin:5px;" size="mini">全部</el-radio>
