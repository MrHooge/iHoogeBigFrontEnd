...
export default {
  ...
  methods: {
    ...
    getData(a, b, c) {
      ...
      findMemberWalletLineByAccount(obj).then(res => {
        if (res.data.error_code == 200) {
          ...
          this.getAll(this.name, this.value1, this.value2);
        } else {
    ...
    getAll(a, b, c) {
      ...
      findMemberWalletLineByAccount(obj)
        .then(res => {
          if (res.data.error_code === 200) {
    ...
    exportSome() {
      ...
      this.newTableData.forEach((e, index) => {
        newobj = {
          ...
          CREATE_DATE_TIME: this.changeTime(e.CREATE_DATE_TIME)
        };
