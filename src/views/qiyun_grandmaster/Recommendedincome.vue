<template>
    <div class="Sunburn">
        <div class="box">
            ...
            <el-button type="primary" style="margin-left:30px;" @click="Addition">被购加款</el-button>
            <el-button type="primary" style="margin-left:30px;" @click="Reward">打赏收入</el-button>
        </div>
        <!-- 表格数据 -->
        <el-table
            :data="tablelist"
...
<script>
import { getRecommendIncomeList,getRewardIncomeList } from '@/api/grandmaster'
export default {
  data() {
    return {
      tablelist: [], // 表格数据
