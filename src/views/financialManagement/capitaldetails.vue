    ...
    exportSome() {
      ...
      this.tableData.forEach((e, index) => {
        newobj = {
          ...
          todaySend: e.todaySend.toFixed(2), //当日赠送
          lotteryCard: e.lotteryCard.toFixed(2), //嘉奖
          lotteryCardUse: e.lotteryCardUse.toFixed(2), //彩金卡使用
          platformCommissionMoney: e.platformCommissionMoney.toFixed(2) //平台收佣
        };
