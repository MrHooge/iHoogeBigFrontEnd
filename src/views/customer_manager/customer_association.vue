<template>
    <div class="association">
         <el-input v-model="account" placeholder="请输入会员账号" style="width:15%;margin-right:50px;margin-bottom:40px;margin-top:40px" clearable></el-input>
