...
//查询渠道下面代理客户
export function findAllMemberByLoginAcc(params) {
    return request.member({
        url: '/user/findAllMemberByLoginAcc',
        method: 'get',
        params: params
    })
}
//查询提交的审核的数据
export function findMemberLogoutReview(params) {
    return request.member({
        url: '/userManage/findMemberLogoutReview',
        method: 'get',
        params: params
    })
}
//注销申请发起
export function memberLogoutReview(params) {
    return request.member({
        url: '/userManage/memberLogoutReview',
        method: 'post',
        data: params
    })
}
//注销申请审核
export function updateMemberLogoutReview(params) {
    return request.member({
        url: '/userManage/updateMemberLogoutReview',
        method: 'get',
        params: params
    })
}